import { CloseRounded } from '@mui/icons-material'; // Removed unnecessary import
        ...
        <Modal open={true} onClose={() => setOpenModal({ state: false, certification: null })}>
            <Container>
                <Wrapper>
                    ...
                    <ButtonGroup>
                        {/* <Button dull href={certification?.drivelink} target='_blank'>View Certifications</Button> */}
                        <Button href={certification?.drivelink} target='new'>View Certifications</Button>
                    </ButtonGroup>
                </Wrapper>
            </Container>
